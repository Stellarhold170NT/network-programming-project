...
-- Bảng 1: users (không phụ thuộc bảng nào)
...
-- Bảng 2: music_mood (không phụ thuộc bảng nào)
...
-- Bảng 3: music (phụ thuộc vào music_mood)
...
-- Bảng 4: game_room (không phụ thuộc bảng nào)
...
-- Bảng 5: player (phụ thuộc vào game_room và users)
